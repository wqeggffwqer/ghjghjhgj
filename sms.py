...
class SendSms():
    ...
    def Dsmartgo(self):    
        ...
        try:
            ...
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ dsmartgo.com.tr")
        except AttributeError:
            print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ dsmartgo.com.tr")
            self.adet += 1
    ...
    def Kigili(self):    
        try:
            ...
            if kigili.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ kigili.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ kigili.com")
    ...
    def KahveDunyasi(self):    
        try:    
            ...
            if len(kahve_dunyasi.json()["meta"]["messages"]["error"]) == 0:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ core.kahvedunyasi.com")
                self.adet += 1
            else:
                raise
        except:    
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ core.kahvedunyasi.com")
    ...
    def PodyumPlus(self):    
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ podyumplus.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ podyumplus.com")
    ...
    def NaosStars(self):
        try:
            ...
            if naosstars.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ shop.naosstars.com")
                self.adet += 1 
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ shop.naosstars.com")
    ...
    def Wmf(self):
        try:
            ...
            if wmf.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ wmf.com.tr")
                self.adet += 1   
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ wmf.com.tr")
    ...
    def IsteGelsin(self):
        try:
            ...
            if (r.json()["data"]["sendOtp2"]["alreadySent"]) == False:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ prod.fasapi.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ prod.fasapi.net")
    ...
    def Bim(self):
        try:
            ...
            if bim.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ bim.veesk.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ bim.veesk.net")
    ...
    def Sok(self):
        try:
            ...
            if len(r.json()["meta"]["messages"]["success"]) != 0:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ api.ceptesok.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ api.ceptesok.com")
    ...
    def Tiklagelsin(self):
        try:
            ...
            if tiklagelsin.json()["data"]["generateOtp"] == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ svc.apps.tiklagelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ svc.apps.tiklagelsin.com")
    ...
    def Migros(self):
        try:
            ...
            if migros.json()["successful"] == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ rest.sanalmarket.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ rest.sanalmarket.com.tr")
    ...
    def A101(self):
        try:
            ...
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ a101.com.tr")
                self.adet += 1
            else:
                raise 
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ a101.com.tr")
    ...
    def Englishhome(self):
        try:
            ...
            if home.status_code == 202:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ englishhome.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ englishhome.com")
    ...
    def Sakasu(self):
        try:
            ...
            if su.json()["status"] == "ok":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ sakasu.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ sakasu.com.tr")
    ...
    def Rentiva(self): 
        try:
            ...
            if rentiva.json()["success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ rentiva.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Lonca(self):
        try:
            ...
            if lonca.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ loncamarket.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ loncamarket.com")   
    ...
    def Dgn(self):
        try:
            ...
            if dgn.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ odeme.dgnonline.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ odeme.dgnonline.com")  
    ...
    def Yaani(self):
        try:
            ...
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ api.yaanimail.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ api.yaanimail.com")  
    ...
    def Defacto(self):
        try:
            ...
            if r.json()["Data"]["IsSMSSend"] == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ defacto.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ defacto.com.tr")
    ...
    def Mopas(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mopas.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ mopas.com.tr")
    ...
    def Icq(self):
        try:
            ...
            if r.json()["status"]["code"] == 20000:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ u.icq.net")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ u.icq.net")
    ...
    def Boyner(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.json()["Success"] == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ boyner.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ boyner.com")
    ...
    def Watsons(self):
        try:
            ...
            if r.status_code == 201:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ watsons.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ watsons.com.tr")
    ...
    def Buyur(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ app.buyursungelsin.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ app.buyursungelsin.com")
    ...
    def Osmanlideal(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ osmgck.idealdata.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ osmgck.idealdata.com.tr")
    ...
    def Pinar(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.text == "true":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ pinarsumobileservice.yasar.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ pinarsumobileservice.yasar.com.tr")
    ...
    def Suiste(self):
        try:
            ...
            if r.json()["code"] == "common.success":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ suiste.com")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Pisir(self):
        try:
            ...
            if r.json()["ok"] == "1":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ api.pisir.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ api.pisir.com")
    ...
    def KimGb(self):
        try:
            ...
            if r.status_code == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ 3uptzlakwi.execute-api.eu-west-1.amazonaws.com")
    ...
    def IkinciYeni(self):
        try:
            ...
            if (r.json()["isSucceed"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ apigw.ikinciyeni.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ apigw.ikinciyeni.com")
    ...
    def Terra(self):
        try:
            ...
            r = requests.post(url,  json=json)
            if (r.status_code) == 201:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ api.terrapizza.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Mogaz(self):
        try:
            ...
            if (r.json()["messageCode"]) == "OK":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mogazmobilapinew.aygaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ mogazmobilapinew.aygaz.com.tr")
    ...
    def GoMobile(self):
        try:
            ...
            if (r.json()["data"]["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ gomobilapp.ipragaz.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ gomobilapp.ipragaz.com.tr")
    ...
    def PetrolOfisi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if r.status_code == 204:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mobilapi.petrolofisi.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ mobilapi.petrolofisi.com.tr")
    ...
    def Total(self):
        try:
            ...
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mobileapi.totalistasyonlari.com.tr")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ mobileapi.totalistasyonlari.com.tr")
    ...
    def Opet(self):
        try:
            ...
            r = requests.post(url, json=json)
            if (r.status_code) == 200:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ api.opet.com.tr")
                self.adet += 1
            else:
                raise
        except:
    ...
    def Tazi(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["kod"]) == "0000":
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mobileapiv2.tazi.tech")
                self.adet += 1
            else:
                raise
        except:
    ...
    def N11(self):
        try:
            ...
            r = requests.post(url, headers=headers, json=json)
            if (r.json()["isSuccess"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ mobileapi.n11.com")
                self.adet += 1
            else:
                raise
        except:
            print(f"{Fore.LIGHTRED_EX}『 NO 』 {Style.RESET_ALL}hata ⇝ mobileapi.n11.com")
    ...
    def Joker(self):
        try:
            ...
            r = requests.post(url, headers=headers, data=data)
            if (r.json()["success"]) == True:
                print(f"{Fore.LIGHTGREEN_EX}『 YES 』 {Style.RESET_ALL}gönderildi ⇝ joker.com.tr")
                self.adet += 1
            else:
                raise
        except:
